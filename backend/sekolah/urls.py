...
urlpatterns = [
    ...
    path('get-tahun-ajaran-list/', views.get_tahun_ajaran_list_api, name='get_tahun_ajaran_list_api'),
    ...
    path('get-guru-mapel-list/', views.get_guru_mapel_list_api, name='get_guru_mapel_list_api'),
]